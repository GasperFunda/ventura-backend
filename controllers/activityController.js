...
module.exports = {
    ...
    update: function (req, res) {
        ...
        ActivityModel.findOne({_id: id}, function (err, activity) {
			...
			activity.direction = req.body.direction ? req.body.direction : activity.direction;
			...
			activity.start_time = req.body.start_time ? req.body.start_time : activity.start_time;
			activity.end_time = req.body.end_time ? req.body.end_time : activity.end_time;
